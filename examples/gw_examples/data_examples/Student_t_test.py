...
outdir_label         = "test_multiband_student_N2"     # Label for output directory, e.g. "test", "test_fixed_nu", "test_GW231123"
single_par           = True           
...
if(likelihood_type == "Gaussian"):
    ...
    raise ValueError("likelihood_type must be one of ['Gaussian', 'Student', 'Student-local']")
